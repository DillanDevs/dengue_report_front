...
function App() {
  return (
    <>
      <header className="py-8 px-4 mx-auto max-w-l lg:py-16 lg:px-8 justify-center">
        <h1 className="text-4xl font-bold leading-tight text-center text-blue-700 lg:text-5xl">
          Detección de dengue con IA
          <br />
          <span className="text-blue-500">por JEDS-Team</span>
        </h1>
